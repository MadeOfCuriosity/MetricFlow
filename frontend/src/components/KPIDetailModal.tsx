...
export function KPIDetailModal({ kpi, isOpen, onClose }: KPIDetailModalProps) {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      className="w-full max-w-2xl bg-dark-900 border border-dark-700 rounded-2xl shadow-xl"
    >
      {/* Header */}
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={history}>
                  ...
                  <Line
                    ...
                    strokeWidth={2}
                    dot={{ fill: CHART_COLORS.brand, strokeWidth: 0, r: 3 }}
                    activeDot={{ fill: CHART_COLORS.brand, strokeWidth: 0, r: 5 }}
                  />
                </LineChart>
              </ResponsiveContainer>
            </div>
