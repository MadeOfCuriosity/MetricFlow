...
/** Single source of the Privacy Policy text — rendered on the public page and in Settings. */
    ...
    <div className={className ?? 'space-y-10 text-dark-200 text-sm leading-relaxed'}>
      ...
      <section>
        ...
        <p className="mb-3">
          ...
          read-only access to Google Sheets (<code className="text-brand">spreadsheets.readonly</code>).
        </p>
        <h3 className="text-base font-semibold text-foreground mb-2">WhatsApp Data (optional)</h3>
        <p className="mb-3">
          If your organization turns on the WhatsApp integration and you choose to connect your number,
          we collect your WhatsApp phone number, the time you verified and opted in, the messages you
          send to and receive from the Visualize WhatsApp number (for example, data values you submit
          by chat), and delivery status information (sent, delivered, read). One-time verification codes
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-dark-300">
          ...
          <li>
            <strong className="text-foreground">WhatsApp (Meta):</strong> When enabled, messages are sent
            and received through the WhatsApp Business Platform operated by Meta Platforms, Inc. Message
            content and your phone number are processed by Meta to deliver messages, subject to{' '}
            <a
            ...
            >
              WhatsApp&rsquo;s Business Policy
            </a>
            .
          </li>
        </ul>
      ...
      <section>
        ...
        <p className="mt-3">
          WhatsApp message records (content and delivery status) are kept as part of your
          organization&rsquo;s activity history and are deleted together with the account.
          Disconnecting WhatsApp removes your phone number from your profile immediately.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-dark-300">
          ...
          <li>
            Stop WhatsApp messages at any time by replying <strong className="text-foreground">STOP</strong>,
            or disconnect your number in Settings &rarr; Account &rarr; WhatsApp
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          <a href="mailto:privacy@visualize.io" className="text-brand hover:text-brand transition-colors">
